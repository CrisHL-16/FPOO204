...
public class MPLVT {
    ...
    public MPLVT(int numeroCuenta, String titular, double saldo, boolean cuentaEnLinea) {
    ...
    public static void main(String[] args) {
        ...
        MPLVT cuenta = new MPLVT(numeroCuenta, titular, saldo, cuentaEnLinea);
